...
const appData = {
  ...
  addPrices: function () {
    ...
    this.screensTotalCount = this.screens.reduce((sum, screen) => (sum += +screen.count), 0);
  ...
  logger: function () {
    ...
    console.log("Стоимость работы за вычетом процента отката посреднику: " + this.servicePercentPrice + " рублей");
  },
